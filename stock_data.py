...
def retrieve_stock_web(dateStart, dateEnd, stock_list): 
    print("🟢 retrieve_stock_web() was called")
...
def retrieve_stock_web(dateStart,dateEnd,stock_list):
    ...
    for stock in stock_list:
        ...
        try:
            driver_path = r"C:\Users\vedik\LAB2\chromedriver-win64\chromedriver.exe"
    ...
    for stock in stock_list:
            if stock.symbol == symbol:
                try: 
                    ...
                    print(f"[Success] Finished importing data for {symbol} from '{filename}'.") 
